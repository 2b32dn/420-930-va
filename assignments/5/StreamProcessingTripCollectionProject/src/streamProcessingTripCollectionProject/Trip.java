...
public class Trip {
  ...
  public String toString() {
    return String.format(
        "Emp Id = %d, Emp Name = %s, Emp Add = %s, Gas Price = %.2f, Distance = %d, Hotel Cost = %.2f, Food Cost = %.2f",
        emp_id, emp_name, emp_address, emp_gasprice, emp_distance, emp_costhotel, emp_costfood);
  }

  public String toString2() {
    return String.format(
        "Emp Id = %d, Emp Name = %s, Emp Add = %s, Gas Price = %.2f, Distance = %d, Hotel Cost = %.2f, Food Cost = %.2f, Cost Trip = %.2f$",
